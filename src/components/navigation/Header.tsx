...
export const Header: React.FC<HeaderProps> = ({ onShowSidebar, showSidebarButton=true}) => {
    const handleLogout = () => {
        removeJwtToken();
    ...
    return (
        <Flex p={4} justifyContent="flex-end" style={{borderBottom:"solid black 1px"}}>
            <Box flex="1" maxWidth="55px">
                {showSidebarButton && (
                    <Button onClick={onShowSidebar}><Icon as={GiHamburgerMenu}/></Button>
                )}
            </Box>
            <Box flex="1">
